...
//                    .setSource(context,Uri.parse("models/video_screen.sfb"))
//                    .build();
//        }
//    }
    public AugmentedImageNode(Context context) {
        ...
        if (Center == null) {
            Center = ModelRenderable.builder()
                    .setSource(context, Uri.parse("models/Mesh_Cat.sfb"))
                    .build();
        }
        if (ulCorner == null) {
            ulCorner =
    ...
    /*public void setImage(AugmentedImage image){
        ...
        if(!Center.isDone()){
            CompletableFuture.allOf(Center).thenAccept((Void aVoid) -> setImage(image))
                    .exceptionally(
                            throwable -> {
    ...
    public void setImage(AugmentedImage image) {
        ...
        if (!Center.isDone()) {
            CompletableFuture.allOf(Center)
